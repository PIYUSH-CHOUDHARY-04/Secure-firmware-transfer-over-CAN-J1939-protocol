...
uint8_t ForwardSubByte(uint8_t input_byte) {
    ...
    */
    ...
    printf("sub byte for %u byte : %u\n",input_byte,Forward_Sbox[input_byte]);
...
void main(void){
    ...
    for(uint8_t i=0;i<16;i++){
        printf("StateArray[%d] : %u\n",i,StateArray[i]);
    }
    printf("-----------------------------------------------------------\n");
    ForwardSubstitutionTransformation(StateArray);
    for(uint8_t i=0;i<16;i++){
        printf("StateArray[%d] : %u\n",i,StateArray[i]);
    }
    printf("-----------------------------------------------------------\n");

    InverseSubstitutionTransformation(StateArray);
    for(uint8_t i=0;i<16;i++){
        printf("StateArray[%d] : %u\n",i,StateArray[i]);
    }
}
